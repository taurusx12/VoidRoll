...
const commands = [
  ...
  new SlashCommandBuilder().setName('autoteam').setDescription('Automatically equip strongest formations').addIntegerOption(o => o.setName('formations').setDescription('Formations 1-6').setRequired(false)),
    ...
    .addStringOption(o =>
      o.setName('item')
        ...
        .addChoices(
          ...
          { name: 'Legendary core - 300,000 Gold', value: 'legendary_orb' },
          { name: 'Mythic core - 900,000 Gold', value: 'mythic_orb' },
          { name: 'Divine core - 2,500,000 Gold', value: 'divine_orb' },
          { name: 'Secret core - 9,000,000 Gold', value: 'secret_orb' }
        )
    ),
  ...
  new SlashCommandBuilder().setName('core-shop').setDescription('Show guaranteed core market'),
